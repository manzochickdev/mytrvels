...
import kr.changhan.mytravels.dao.HotPlaceDao;
...
@Database(entities = {Travel.class, TravelPlan.class, TravelDiary.class, TravelExpense.class, HotPlace.class}, version = 2, exportSchema = false)
